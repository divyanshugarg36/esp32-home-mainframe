...
void sendSensor()
{
  if (isAHTActive)
  {
    ...
    Serial.print("Humidity: " + String(humi.relative_humidity) + "% rH");
    temperature.updateAndReportParam("Temperature", temp.temperature);
    humidity.updateAndReportParam("Humidity", humi.relative_humidity);
  }
}
